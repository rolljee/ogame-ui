...
function Mining() {
	...
	return (
		<>
			<FontAwesomeIcon icon={faCog} className="text-white float-end m-2" onClick={() => setShow(true)} />
			<FontAwesomeIcon icon={faEdit} className="text-white float-end m-2" onClick={() => setEdit(!edit)} />
